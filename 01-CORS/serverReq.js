...
// __dirname始终指向当前js代码文件(serverReq.js)所在的目录, 在我的本地目录是D:\cross-domain\CROS
// console.log(__dirname) 在dos窗口可以看到
// 上面“express.static(__dirname + '/static')”的意思项目的静态文件目录在 D:\cross-domain\CROS\static
// 可以在static里面随便加入b.html, 然后在http://localhost:3000/b.html可以显示
